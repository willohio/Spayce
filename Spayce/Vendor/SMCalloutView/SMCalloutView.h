...
// This property sets the background color of the popup
@property (nonatomic, strong) UIColor *backgroundColor;

// Thsi property sets whether or not the bottom portion of the callout has sharp edges or is rounded
@property (nonatomic) BOOL useSharpEdges;
