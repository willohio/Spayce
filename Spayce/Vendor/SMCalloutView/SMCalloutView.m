...
@property (nonatomic, strong) UIView *containerView, *arrowView;
...
- (id)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        self.containerView.layer.shadowOffset = CGSizeMake(0.0f, 0.5f);
        ...
        if (!blackArrowImage) {
            ...
            whiteArrowImage = [self image:blackArrowImage withColor:_backgroundColor];
...
- (void)setUseSharpEdges:(BOOL)useSharpEdges {
    // Set the property
    _useSharpEdges = useSharpEdges;
    
    [self setArrowImages];
}

- (void)setArrowImages {
    NSString *imageName = @"CalloutArrow"; // Default
    if (self.useSharpEdges) {
        imageName = @"CalloutArrowSharpEdges";
    }
    
    UIColor *backgroundColor = [UIColor whiteColor]; // Default
    if (nil != _backgroundColor)
    {
        backgroundColor = self.backgroundColor;
    }
    
    // Set the arrow images and their associated imageViews
    blackArrowImage = [SMCalloutBackgroundView embeddedImageNamed:imageName];
    whiteArrowImage = [self image:blackArrowImage withColor:self.backgroundColor];
    grayArrowImage = [self image:blackArrowImage withColor:[UIColor colorWithWhite:0.85 alpha:1]];
    self.arrowImageView.image = whiteArrowImage;
    self.arrowHighlightedImageView.image = grayArrowImage;
    self.arrowBorderView.image = blackArrowImage;
...
+ (UIImage *)embeddedImageNamed:(NSString *)name {
    if (1.0f < [UIScreen mainScreen].scale && 3.0f >= [UIScreen mainScreen].scale) // Support for "$2x", "$3x"
...
+ (NSString *)CalloutArrow$3x { return @""; }

+ (NSString *)CalloutArrowSharpEdges { return @""; }

+ (NSString *)CalloutArrowSharpEdges$2x { return @""; }

+ (NSString *)CalloutArrowSharpEdges$3x { return @""; }
