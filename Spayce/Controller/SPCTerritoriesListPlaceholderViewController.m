//
//  SPCTerritoriesListPlaceholderViewController.m
//  Spayce
//
//  Created by Arria P. Owlia on 12/10/14.
...
@interface SPCTerritoriesListPlaceholderViewController ()
...
@implementation SPCTerritoriesListPlaceholderViewController
...
- (UIView *)customNavigationBar {
    if (!_customNavigationBar) {
        ...
        NSString *titleText = @"TERRITORIES";
...
- (UILabel *)messageTitleLabel {
    if (!_messageTitleLabel) {
        NSString *message = @"Hang on Columbus!";
...
- (UILabel *)messageLabel {
    if (!_messageLabel) {
        NSString *message = [NSString stringWithFormat:@"Add %@ to see this territories list.", self.userProfile.profileDetail.firstname];
