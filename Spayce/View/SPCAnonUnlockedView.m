//
//  SPCAnonUnlockedView.m
//  Spayce
//
//  Created by Christopher Taylor on 2/5/15.
//  Copyright (c) 2015 Spayce Inc. All rights reserved.
//

#import "SPCAnonUnlockedView.h"

@interface SPCAnonUnlockedView ()
...
@implementation SPCAnonUnlockedView
...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        // Images
        _imageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"anonUnlockBadge"]];
        ...
        _headerLabel.text = @"Congratulations! You have\njust unlocked the ability\nto make anonymous\nmemories!";
        ...
        _subheadLabel.text = @"Be a responsible member of the community\nor this privilege will be revoked.";
...
- (void)layoutSubviews {
    ...
    self.subheadLabel.frame = CGRectMake(leftRightPadding, CGRectGetMaxY(self.headerLabel.frame) + subheadToTextPadding, CGRectGetWidth(self.contentView.frame) - 2 * leftRightPadding, self.subheadLabel.font.lineHeight * 2);
