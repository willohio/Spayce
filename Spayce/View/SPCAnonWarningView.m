...
@implementation SPCAnonWarningView
...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        _headerLabel.text = @"An anonymous memory\nthat you have made is\nunder review due to\nnumerous reports.";
