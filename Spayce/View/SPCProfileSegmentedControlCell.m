//
//  SPCProfileSegmentedControlCell.m
//  Spayce
//
...
NSString *SPCProfileSegmentedControlCellIdentifier = @"SPCProfileSegmentedControlCellIdentifier";

@interface SPCProfileSegmentedControlCell()
...
@implementation SPCProfileSegmentedControlCell
...
- (void)tappedGridButton:(id)sender {
    self.memoryCellDisplayType = MemoryCellDisplayTypeGrid;
    [Flurry logEvent:@"PROFILE_TILE_BTN_TAPPED"];
}
...
- (void)setMemoryCellDisplayType:(MemoryCellDisplayType)memoryCellDisplayType {
    if (memoryCellDisplayType != self.memoryCellDisplayType) {
        ...
        if ([self.delegate respondsToSelector:@selector(tappedMemoryCellDisplayType:onProfileSegmentedControl:)]) {
            [self.delegate tappedMemoryCellDisplayType:memoryCellDisplayType onProfileSegmentedControl:self];
        }
    }
}
