...
@implementation SPCFriendUserCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _actionButtonWidthConstraint = [NSLayoutConstraint constraintWithItem:_actionButton attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeWidth multiplier:1.0 constant:65];
        [self.contentView addConstraint:_actionButtonWidthConstraint];
...
- (void)configureWithFriendId:(NSInteger)friendId text:(NSString *)text detailText:(NSString *)detailText url:(NSURL *)url {
    self.actionButtonWidthConstraint.constant = (friendId == -1) ? 0.0 : 65.0;
