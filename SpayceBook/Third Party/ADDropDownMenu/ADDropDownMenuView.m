...
- (void)addContainerView{
    ...
    CGRect frame = ((ADDropDownMenuItemView *)[self.itemsViews firstObject]).bounds;
    
    self.containerView = [[UIView alloc] initWithFrame:CGRectMake(0.0, 0.0, frame.size.width, 0.0) ];
...
- (void)contract{
    ...
    CGRect contractedFrame = (CGRect){.origin = self.containerView.frame.origin,
        .size = CGSizeMake(self.containerView.frame.size.width, 0.0/*[ADDropDownMenuView contractedHeightForItemsViews: self.itemsViews]*/)};
