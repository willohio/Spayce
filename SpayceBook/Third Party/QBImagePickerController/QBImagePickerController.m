...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [[UIBarButtonItem appearanceWhenContainedIn:[UINavigationBar class], nil] setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:[UIColor clearColor], NSForegroundColorAttributeName,nil] forState:UIControlStateDisabled];
        ...
        [self.assetsLibrary assetForURL:selectedAssetURL
                            resultBlock:^(ALAsset *asset) {
                                ...
                                if (asset) {
                                    ...
                                    //it's a photo stream asset, we need to find it by enumeration (!)
