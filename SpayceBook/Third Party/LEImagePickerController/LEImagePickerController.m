...
- (void)layoutSubviews;
{
    ...
    switch (self.interfaceOrientation)
    {
        ...
        case UIInterfaceOrientationPortraitUpsideDown:
            ...
            [[NSNotificationCenter defaultCenter] postNotificationName:@"flipV" object:nil];
            break;
        case UIInterfaceOrientationLandscapeRight:
            self.button.frame = CGRectMake(CGRectGetMaxX(self.bounds) - width, CGRectGetMaxY(self.bounds) - height - 50.0f, width, height);
            [[NSNotificationCenter defaultCenter] postNotificationName:@"flipH" object:nil];
            break;
...
{
    [super viewDidLoad];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(flipV) name:@"flipV" object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(flipH) name:@"flipH" object:nil];
