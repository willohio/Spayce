...
{   
    ...
    float scaleValue = [self alphaForItemWithOffset:offset];
    if (scaleValue < .8) {
        scaleValue = .8;
    }
    scale = CATransform3DMakeScale(scaleValue, scaleValue, scaleValue);
    CATransform3D compound = CATransform3DConcat(transform, scale);
    ...
    switch (_type)
    {
        ...
        case iCarouselTypeLinear:
        {
            ...
            {
                return CATransform3DTranslate(compound, offset * _itemWidth * spacing, 0.0f, 0.0f);
            }
        }
